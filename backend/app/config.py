...
class Settings(BaseModel):
    app_name: str = Field(default_factory=lambda: os.getenv("APP_NAME", "Gestão de Ocorrências API"))
    ...
    database_url: str = Field(
        default_factory=lambda: os.getenv(
            "DATABASE_URL",
            "postgresql+psycopg://incidents_user:incidents_pass@localhost:5434/incidents_db",
        ),
